...
public class UserProfile1 extends javax.swing.JFrame {
    ...
    public UserProfile1(int userId) {
        initComponents();
     setLocationRelativeTo(null);
        ...
        try {
            ...
            if (rs.next()) {
                id.setText("ID: " + rs.getInt("id"));
                fullname1.setText("Fullname: " + rs.getString("fullname"));
                Username1.setText("Username: " + rs.getString("username"));
                password1.setText("Password: " + rs.getString("password"));
                email1.setText("Email: " + rs.getString("email"));
                phonenumber1.setText("PhoneNumber: " + rs.getString("phonenumber"));
                Usernamehere.setText(rs.getString("username"));
            } else {
    ...
    private void initComponents() {
        ...
        jPanel4.add(Usernamehere, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 280, 250, 40));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1190, 780));
